...
pvp_cor = round(cor(crt_data$Pretest, crt_data$Posttest, method = "pearson"), 2)
...
- There is a moderate correlation of `r pvp_cor` between Pretest and Posttest scores. Grey area represents the 95% confidence interval. 
