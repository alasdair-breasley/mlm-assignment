...
- There is only a small reduction in deviance when adding FSM and there is insufficient evidence against the null hypothesis that the fixed effect of FSM is 0. The null hypothesis is therefore retained and FSM is not needed. 
