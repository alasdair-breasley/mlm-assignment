...
__2-Level Random Intercept Model for School with Pretest Pupil Level Covariate (Both Fixed Effect and Random Slope)__

```{r}

# Fit random intercept model for school with Pretest (both fixed effect and random slope) 
random_intercept_Pretest_slope_model = lmer(formula = Posttest ~ 1 + Pretest + (1 + Pretest | School), data = crt_data)

summary(random_intercept_Pretest_slope_model)
...
ranova(random_intercept_Pretest_slope_model)
